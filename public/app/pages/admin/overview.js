...
import { Icon, Meter, Skeleton } from '../../components/ui.js';
...
export default function Overview() {
  ...
  const cards = data
    ? [
        ...
        { icon: 'megaphone', label: t('admin.pendingPromotions'), value: fmtNumber(data.pendingPromotions), href: '/social?panel=queue' },
      ]
    : [];
